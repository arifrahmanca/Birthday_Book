note
	description: "[
		...
		Model is REL[NAME,BIRTHDAY]
		Efficient implementation with LINKED_LIST
	]"
	author: "JSO"
	date: "2020-01-30"
	revision: "$Revision$"
...
--			end
			...
			across list as l all Result.domain.has (l.item.name) end			
...
--			across list is tuple
--			loop
--				a.force (tuple.name, a.upper + 1)
--			end

--			if a.has (a_name) then
--				across list is l
--				loop
--					if l.name ~ a_name then
--						list.prune (l)
--					end
--				end
--			end
